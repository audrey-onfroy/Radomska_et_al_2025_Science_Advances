...
This file is used to generate a dataset containing the donor and the recipient datasets.
...
```{r cell_type_proj, fig.width = 14, fig.height = 5}
...
```{r clustering_proj, fig.width = 14, fig.height = 5}
plot_list = lapply(sobj_list, FUN = function(one_sobj) {
  mytitle = as.character(unique(one_sobj$project_name))
  mysubtitle = ncol(one_sobj)
...
```{r plot_split_dimred_cluster, fig.width = 12, fig.height = 5}
...
```{r cell_type_split, fig.width = 14, fig.height = 5}
plot_list = aquarius::plot_split_dimred(sobj,
                                        reduction = name2D,
                                        split_by = "project_name",
                                        split_color = setNames(sample_info$color,
...
```{r table_cell_type, fig.width = 12, fig.height = 5, class.source = "fold-hide"}
...
```{r prop_cell_type, fig.width = 12, fig.height = 5, class.source = "fold-hide"}
df_quantities = table(sobj$cell_type,
                      sobj$project_name) %>%
  prop.table(., margin = 2) %>%
  "*"(100) %>% round(., 2) %>%
...
```{r tomato_split, fig.width = 14, fig.height = 5}
plot_list = aquarius::plot_split_dimred(sobj,
                                        reduction = name2D,
                                        split_by = "project_name",
                                        split_color = setNames(sample_info$color,
