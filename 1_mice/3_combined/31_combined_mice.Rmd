...
```{r table_cell_type, fig.width = 30, fig.height = 5, class.source = "fold-hide"}
...
```{r prop_cell_type, fig.width = 30, fig.height = 5, class.source = "fold-hide"}
df_quantities = table(sobj$cell_type,
                      sobj$project_name) %>%
  prop.table(., margin = 2) %>%
  "*"(100) %>% round(., 2) %>%
...
```{r tomato_split, fig.width = 14, fig.height = 10}
plot_list = aquarius::plot_split_dimred(sobj,
                                        reduction = name2D,
                                        split_by = "project_name",
                                        split_color = setNames(sample_info$color,
